...
The [Widget Box Lite](https://theme4press.com/widget-box/) plugin comes with a great bunch of widgets designed specially for [Theme4Press](https://theme4press.com/) themes users to utilize their websites with extra features. The plugin has now included following widgets:
...
[**Social Media Links**](https://demo.theme4press.com/widget-box/social-media-links-widget/) - if you need to add your social media links, use this widget to show Facebook, Twitter link and more
...
[**Contact Info**](https://demo.theme4press.com/widget-box/contact-info-widget/) - contact info widget lets you to display your address, phone, fax or an email address

### Premium Version Features

= The premium version of this plugin add even more settings to the existing free widgets and bring some extra new ones to add a lot of great features. It unlocks following features: =

**Posts Slider** - you can select up to 4 items per slide (multi item slide), 30 posts per widget, change display order, select multiple post categories, include only sticky posts, hide post titles, hide post metas, customize the post excerpts and more links, custom image sizes, 3 slider content layouts, link slides to the posts, modify the font size of titles and contents, options to set arrows, indicators and animation style

**Recent Posts** - set up to 3 columns of posts, 30 posts per widget, change display order, select multiple post categories, include only sticky posts, hide post titles, hide post metas, customize the post excerpts and more links, custom image sizes, up to 4 post layouts, enable thumbnail shadow and animation effects, borders and colors, modify the font size of titles and contents, enable border radius and boxed style of the posts

**Social Media Links** - up to 25 social media links + 5 custom ones (Font Awesome icons), change position of the tooltip, icons boxed styles and custom colors, extra media links - Google+, Dribbble, LinkedIn, Blogger, Tumblr, Reddit, Yahoo!, DeviantArt, Vimeo, YouTube, Pinterest, Digg, Flickr, Forrst, Myspace, Skype, Instagram, VK, PayPal, Dropbox, SoundCloud
...
[**Contact Form**](https://demo.theme4press.com/widget-box/contact-form-widget/) - an ajax contact form which will let visitors of your website contact you in a quick and simple way, protected with the Google reCAPTCHA verification, available fields - company name, name, email, phone, address, subject, message
...
[**Google Map**](https://demo.theme4press.com/widget-box/google-map-widget/) - the Google Map widget will help you to display a location, for example of your office. Many settings are available, like add multiple addresses, set the size of the map, map types, zoom level, enable/disable the map pin, controls and tooltip

[**Instagram Photos**](https://demo.theme4press.com/widget-box/instagram-photos-widget/) - display any photos of the Instagram, all it's up to you. Many predefined styles, effects, you can add up to 30 photos per widget, up to 5 columns layout, photo spacing, custom photo sizes, enable tooltip to display the photo titles, shadow and hover animation effects, border and rounded styles
...
[**Twitter Tweets**](https://demo.theme4press.com/widget-box/twitter-tweets-widget/) - recent tweets can be automatically shown on any predefined widget area on your page. This widget lets you to add your Twitter username, API Keys, up to 30 tweets per widget, display your image, enable border or light background style

== Installation ==

* a) Install the plugin through WordPress plugins page by searching the **Widget Box Lite** term and click **Install Now** button
